...
type Message struct {
	...
	GasFeeCap          string     `json:"gas_fee_cap" bson:"gas_fee_cap"`
	GasPremium         string     `json:"gas_premium" bson:"gas_premium"`
	BaseFeeBurn        string     `json:"base_fee_burn" bson:"base_fee_burn"`
	OverEstimationBurn string     `json:"over_estimation_burn" bson:"over_estimation_burn"`
	MinerPenalty       string     `json:"miner_penalty" bson:"miner_penalty"`
	MinerTip           string     `json:"miner_tip" bson:"miner_tip"`
	Refund             string     `json:"refund" bson:"refund"`
